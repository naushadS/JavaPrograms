...
public class AESFileEncryption {
	public static void main(String[] args) throws Exception {
		...
		//Get from user the value to be stored into the file
		System.out.println("Enter the information to be stored in the file:");
		...
		// encrypted file
		FileOutputStream outFile = new FileOutputStream(filename+"_encrypted.des");
